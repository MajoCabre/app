...
const ItemDetailContainer = () => {
    ...
    const promise = new Promise((resolve)=>{
        const detalle = [
            {id:1, nombre:"Vainilla Cake", precio:"$400", img:"vanila.jpg", descripcion:"Deliciosa, esponjosa y casera torta de vainilla, es una excelente opción a la hora de merendar..."}
        ];
